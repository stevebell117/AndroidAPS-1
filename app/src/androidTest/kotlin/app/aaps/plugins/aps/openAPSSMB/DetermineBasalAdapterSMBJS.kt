...
class DetermineBasalAdapterSMBJS(private val scriptReader: ScriptReader, private val injector: HasAndroidInjector) : DetermineBasalAdapter {
    ...
    override fun setData(
        ...
        this.profile.put("high_bg", profile.getTargetHighMgdl())
        ...
        this.profile.put("enableSMB_high_bg", smbEnabled && preferences.get(BooleanKey.ApsUseSMBHighBg) && advancedFiltering)
